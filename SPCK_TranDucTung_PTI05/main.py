...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi('Lessons/SPCK_TranDucTung_PTI05/notes_manager.ui', self)
        ...
        self.users_file = 'Lessons/SPCK_TranDucTung_PTI05/users.json'
        self.notes_file = 'Lessons/SPCK_TranDucTung_PTI05/notes.json'
        self.ensure_files()
